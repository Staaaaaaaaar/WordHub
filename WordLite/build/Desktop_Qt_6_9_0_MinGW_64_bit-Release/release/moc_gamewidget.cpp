...
template <> constexpr inline auto GameWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10GameWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onGuessWordWidgetExit'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onBeginSignalCome'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onAnswerSignalCome'
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onGuessWordWidgetExit(); break;
        case 1: _t->onBeginSignalCome(); break;
        case 2: _t->onAnswerSignalCome(); break;
        default: ;
        }
    }
    (void)_a;
