/****************************************************************************
** Meta object code from reading C++ file 'achievementwidget.h'
**
...
#error "The header file 'achievementwidget.h' doesn't include <QObject>."
...
void AchievementWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->refreshAchievements(); break;
        default: ;
        }
    }
    (void)_a;
